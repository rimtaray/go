                            ...
                            <div class="row no-gutters">
                                <div class="col-md-6 order-md-1 bg-white">
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        ...
                                        <form class="js-validation-signin" action="{{ URL::asset('/loginme') }}" method="post">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-alt" id="username" name="username" placeholder="Username" autofocus>
                                            </div>

                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-alt" id="password" name="password" placeholder="Password" value="">
                                            </div>
                                    ...
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <a class="text-white-75 font-w600" href="javascript:void(0)">Wayne Garcia, Web Developer</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
