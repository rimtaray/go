                                ...
                                <div class="col-md-6 order-md-1 bg-white">
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        ...
                                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">                
                                            <input id="name" type="text" class="form-control form-control-alt" name="name" value="{{ old('name') }}" placeholder="Name" required autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            <input id="email" type="email" class="form-control form-control-alt" name="email" value="{{ old('email') }}" required placeholder="Email">
                                        ...
                                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                            <input id="password" type="password" class="form-control form-control-alt" name="password" placeholder="Password" required>
                                        ...
                                        <div class="form-group">
                                            <input id="password-confirm" type="password" class="form-control form-control-alt" name="password_confirmation" placeholder="Password Confirm" required>
                                        </div>
