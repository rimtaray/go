            ...
            <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 50%;">ชื่อสกุลเงิน</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{ $data->cu_status}}</td>
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="#modalForm" data-toggle="modal"
                                   data-href="{{ url('payment/edit/'.$data->cu_id) }}">
