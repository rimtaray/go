            ...
            <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 20%;">ค่าธรรมเนียม</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{ $data->cc_status }}</td>
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="#modalForm" data-toggle="modal"
                                   data-href="{{ url('payment/edit/'.$data->cc_id) }}">
