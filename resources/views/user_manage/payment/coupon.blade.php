            ...
            <div class="row mb-2">
                <div class="col-12">
                    <div class="text-right">
                        ...
                        <a href="{{ url('payment/coupon') }}">
                        <button type="button" class="btn btn-hero-sm btn-hero-info">
                            <i class="fa fa-play mr-1"></i> บัตรกำนัล
                        </button>
                        </a>
                        <a href="{{ url('payment/currency') }}">
                        <button type="button" class="btn btn-hero-sm btn-outline-info">
                            <i class="fa fa-play mr-1"></i> สกุลเงินอื่น
                        </button>
                        </a>
                    </div>
                </div>
            ...
            <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 15%;">เลขที่บัตรกำนัล</th>
                        <th class="text-center" style="width: 25%;">มูลค่า</th>
                        <th class="text-center" style="width: 15%;">วันเริ่มใช้งาน</th>
                        <th class="text-center" style="width: 15%;">วันหมดอายุ</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{ $data->co_number }}</td>
                        <td class="text-left">{{ $data->co_value}}</td>
                        <td class="text-left">{{ $data->co_start }}</td>
                        <td class="text-left">{{ $data->co_end }}</td>
                        <td class="text-center">{{ $data->co_status }}</td>
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="#modalForm" data-toggle="modal"
                                   data-href="{{ url('payment/edit/'.$data->co_id) }}">
