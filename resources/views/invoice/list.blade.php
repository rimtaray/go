...
<div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">รายการใบกำกับภาษี</h3>
        </div>
        <div class="block-content block-content-full">
            ...
            <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        <th class="text-center" style="width: 15%;">วันที่ออก</th>
                        <th class="text-center" style="width: 15%;">เลขที่ใบเสร็จ</th>
                        <th class="text-center" style="width: 15%;">เลขที่ใบกำกับฯ</th>
                        <th class="text-center" style="width: 15%;">เลขที่อ้างอิง</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{ $inv->i_date }}</td>
                        <td class="text-center">{{ $inv->sb_no }}</td>
                        <td class="text-center"><a href="{{ url('/invoice/paper/'.$inv->i_no) }}">{{ $inv->i_no }}</a></td>
                        <th class="text-center">{{ $inv->i_refer }}</th>
                        <td class="text-left">{{ $inv->u_name }}</td>
                        <td class="text-center">{{ $inv->i_status }}</td>
