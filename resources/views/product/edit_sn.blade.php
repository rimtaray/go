...
{!! Form::model($sproduct, array('url'=>'productsn/'.$sproduct->p_id, 'method'=>'put','files'=>true, 'OnSubmit'=>'return fncSubmit_edit();', 'name'=>'form1', 'role'=>'form1')) !!}
...
<div class="block block-themed block-transparent mb-0">
    ...
    {{ csrf_field() }}
    <input name="ck" type="hidden" value="edit_sn">
    <div class="text-center"><img src="{{ asset('images_product/resize/'.$sproduct->p_image) }}"></div>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content tab-content">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                {!! Form::text('t_name',$sproduct->p_name, ['class'=>'form-control','placeholder'=>'ระบุชื่อสินค้า','maxlength'=>'100']); !!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                {!! Form::text('t_low',$sproduct->p_low, ['class'=>'form-control','placeholder'=>'ระบุแจ้งเตือนจำนวนขั้นต่ำ','maxlength'=>'3', 'onkeypress'=>'CheckNum()']); !!}
                </div>
            </div>
    
            <div class="form-group row">
                {!! Form::label('s_status','สถานะ', ['class'=>'col-sm-5 col-form-label']); !!}
                <div class="col-sm-7">
