...
{!! Form::model($import, array('url'=>'productsn/'.$import->pd_id, 'method'=>'put', 'OnSubmit'=>'return fncSubmit_edit_importsn();', 'name'=>'form1', 'role'=>'form1')) !!}
...
<div class="block block-themed block-transparent mb-0">
    ...
    <div class="row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            {!! Form::text('t_cost',$import->pd_cost, ['class'=>'form-control','placeholder'=>'ระบุราคาทุน']); !!}
            </div>
        </div>
