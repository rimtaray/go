                        ...
                        <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 10%;">ราคาทุน</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ App\TbProductSn::where('pd_id',$import->pd_id)->sum('ps_num') }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            data-href="{{ url('/productsn/editimport/'.$import->pd_id) }}">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="#modalForm" data-toggle="modal"
                                            data-href="{{ url('/productsn/add_snplus/'.$import->pd_id) }}">
