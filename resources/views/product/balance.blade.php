    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">สินค้าคงเหลือ</h1>
...
<div class="block block-rounded block-bordered">
    <div class="block-header block-header-default">
        <h3 class="block-title">รายการสินค้าคงเหลือ Non s/n</h3>
    </div>
        ...
        <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 10%;">ซื้อเพิ่ม</th>
                    <th class="text-center" style="width: 15%;">เพิ่มในรายการซื้อ</th>
                </tr>
            </thead>
            <tbody>
...
<div class="block block-rounded block-bordered">
    <div class="block-header block-header-default">
        <h3 class="block-title">รายการสินค้าคงเหลือ s/n</h3>
    </div>
    <div class="block-content block-content-full">
        <!-- DataTables init on table by adding .js-dataTable-full class, functionality initialized in js/pages/be_tables_datatables.js -->
        <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center">{{ $isn++ }}</td>
                    <td class="text-center">{{ $data_sn->cat_name }}</td>
