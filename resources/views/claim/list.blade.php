...
<div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">รายการเคลมสินค้า</h3>
        </div>
            ...
            <table class="table table-bordered table-hover table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 15%;">ชื่อผู้เคลม</th>
                        <th class="text-center" style="width: 10%;">ออกวันที่</th>
                        <th class="text-center" style="width: 15%;">ผู้ออก</th>
                        <th class="text-center" style="width: 10%;">รายการ</th>
