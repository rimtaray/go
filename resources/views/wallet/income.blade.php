...
<div class="row">
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-content">
                    ...
                    @endif
                    <!-- Basic Elements -->
                    <h2 class="content-heading pt-0">รายได้</h2>
                    <div class="row push">

                        <div class="col-12">
    
                        {!! Form::open(array('url'=>'wallet_income')) !!}

                        {{ csrf_field() }}
                            <div class="form-group">
                                {!! Form::label('s_cat','ประเภทหมวดหมู่'); !!}
                                {!! Form::select('s_cat', $scat, null, ['class'=>'form-control', 'placeholder'=>'ระบุหมวดหมู่รายได้']); !!}
                            </div>
                            <div class="form-group">
            ...
            <!-- Dynamic Table Full -->
                <div class="block block-rounded block-bordered">
                    <div class="block-header block-header-default">
                        ...
                        <h3 class="block-title">รายการรายได้ เดือน <?=$txt_date . ' ' . date('Y'); ?></h3>
                    </div>
                        ...
                        <th class="text-center" style="width: 5%;"></th>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ url('/wallet_income/'.$wallet->w_id.'/edit') }}">
